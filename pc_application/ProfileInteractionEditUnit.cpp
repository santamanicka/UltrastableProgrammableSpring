...
#pragma resource "*.dfm"
TProfileInteractionEditForm *ProfileInteractionEditForm;
//---------------------------------------------------------------------------
__fastcall TProfileInteractionEditForm::TProfileInteractionEditForm(TComponent* Owner)
	: TForm(Owner)
{


	SetupProfileSwitchTab->Execute();
    SetupInterProfileCommTab->Execute();
    TriggerListWarning->Execute();
}
//---------------------------------------------------------------------------
void __fastcall TProfileInteractionEditForm::SetupProfileSwitchTabExecute(TObject *Sender)
{
    ...
    Title = "Conditional Profile Switchers for Profile ";
    Title += CurrentProfile;
    SwitcherTitle->Caption = Title;
    ...
    AltProTargetlist1->Items->Add("RND");
    AltProTargetlist2->Items->Add("RND");
    AltProTargetlist3->Items->Add("RND");
    AltProTargetlist4->Items->Add("RND");
...
//---------------------------------------------------------------------------
void __fastcall TProfileInteractionEditForm::SaveAndCloseExecute(
      TObject *Sender)
{
	//Save the settings back to the parent form

    SaveProfileSwitchTab->Execute();
    SaveInterProfileCommTab->Execute();
    ProfileInteractionEditForm->Close();
}
//---------------------------------------------------------------------------

void __fastcall TProfileInteractionEditForm::TriggerListWarningExecute(
      TObject *Sender)
{
    ...
    WarningLabel2->Caption = Message1;//AltproTriggerlist1->Items->Strings[AltproTriggerlist1->ItemIndex];//Message1;
}
//---------------------------------------------------------------------------

void __fastcall TProfileInteractionEditForm::SetupInterProfileCommTabExecute(
      TObject *Sender)
{
	//
    AnsiString Title = "Inter Profile Communications for Profile ";
    Title += CurrentProfile;
    CommTitle->Caption = Title;

    OwnComVariableIndex1 =_GlobalVariable1_0 + ProfileEditForm->CurrentEditingProfile;
    OwnComVariableIndex2 =_GlobalVariable2_0 + ProfileEditForm->CurrentEditingProfile;

    OwnComFlagIndex1 =_GlobalFlag1_0 + ProfileEditForm->CurrentEditingProfile;
    OwnComFlagIndex2 =_GlobalFlag2_0 + ProfileEditForm->CurrentEditingProfile;

    VariableSourceBox1->Items = ProfileEditForm->VariableList16;
    VariableSourceBox1->ItemIndex = ProfileEditForm->TempSI16Ptr[_GlobalVariable1_ptr];
    VariableSourceBox2->Items = ProfileEditForm->VariableList16;
    VariableSourceBox2->ItemIndex = ProfileEditForm->TempSI16Ptr[_GlobalVariable2_ptr];


    FlagSourceBox1->Items = ProfileEditForm->VariableList8;
    FlagSourceBox1->ItemIndex = ProfileEditForm->TempI8Ptr[_GlobalFlag1_ptr];
    FlagSourceBox2->Items = ProfileEditForm->VariableList8;
    FlagSourceBox2->ItemIndex = ProfileEditForm->TempI8Ptr[_GlobalFlag2_ptr];

}
//---------------------------------------------------------------------------

void __fastcall TProfileInteractionEditForm::SaveProfileSwitchTabExecute(
      TObject *Sender)
{
	//Save the settings back to the parent form
    int ListIndex =0;
...
void __fastcall TProfileInteractionEditForm::SaveInterProfileCommTabExecute(
      TObject *Sender)
{

    ProfileEditForm->TempSI16Ptr[_GlobalVariable1_ptr] = VariableSourceBox1->ItemIndex;
    ProfileEditForm->TempSI16Ptr[_GlobalVariable2_ptr] = VariableSourceBox2->ItemIndex;

    ProfileEditForm->TempI8Ptr[_GlobalFlag1_ptr] = FlagSourceBox1->ItemIndex;
    ProfileEditForm->TempI8Ptr[_GlobalFlag2_ptr] = FlagSourceBox2->ItemIndex;
}
//---------------------------------------------------------------------------

void __fastcall TProfileInteractionEditForm::CancelAndCloseExecute(
      TObject *Sender)
{
	ProfileInteractionEditForm->Close();
}
...
void __fastcall TProfileInteractionEditForm::SetDefaultsExecute(
      TObject *Sender)
{
	//
    ...
    {
    case 0:
    	SetSwitcherDefaults->Execute();
        break;
    case 1:
    	SetInterCommDefaults->Execute();
        break;
    default:
    	break;
    }
...
void __fastcall TProfileInteractionEditForm::SetSwitcherDefaultsExecute(
      TObject *Sender)
{
	//Set default values
...
void __fastcall TProfileInteractionEditForm::SetInterCommDefaultsExecute(
      TObject *Sender)
{
    VariableSourceBox1->ItemIndex = _GlobalDefaultZeroModulator;

    VariableSourceBox2->ItemIndex = _GlobalDefaultZeroModulator;

    FlagSourceBox1->ItemIndex = _GlobalDefaultFalse;

    FlagSourceBox2->ItemIndex = _GlobalDefaultFalse;
}
//---------------------------------------------------------------------------
