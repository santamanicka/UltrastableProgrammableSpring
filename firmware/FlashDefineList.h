//defines for the system variables so they can be stored in flash.

//int8*  Int8Pointers[64][PROFILES];
//int8  Int8Variables[64][PROFILES];

//signed int16* SInt16Pointers[32][PROFILES];
//signed int16  SInt16Variables[32][PROFILES];
...
#define        _ExIn2Flag                   78                   
#define        _NotExIn2Flag               79                      
#define        _LimitIn1Flag               80                      
#define        _LimitIn2Flag                81

#define        _GlobalDefaultFalse            82 // always 0
#define        _GlobalDefaultTrue            83 // always 1
//===========================================================================
//SInt16 Ptr ------------------------------------------------------------
...
#define        _GlobalDefaultZeroModulator 74
